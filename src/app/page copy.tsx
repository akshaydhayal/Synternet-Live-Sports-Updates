...
//   const updateDataFromLiveSource = useCallback(
//     (data) => {
//       if (data.liveMatchDetails && data.liveMatchDetails.length > 0) {
//         setLiveMatches(data.liveMatchDetails);
//       }
//       if (data.liveMatchStats && data.liveMatchStats.length > 0 && selectedMatch) {
//         const updatedMatch = data.liveMatchStats.find((match) => Object.keys(match)[0] === selectedMatch.id);
//         console.log("updateMatch: ",updatedMatch);
//         console.log("updateMatch: ",JSON.stringify(updatedMatch));
//         if (updatedMatch) {
//           setSelectedMatch(Object.values(updatedMatch)[0]);
//         }
//       }
//       setLastUpdated(new Date().toLocaleString());
//     },
...
//     (data) => {
//       updateDataFromLiveSource(data);
//     },
//     [updateDataFromLiveSource]
//   );
...
//       <Header onDataUpdate={onDataUpdate} />
